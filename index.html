...
<body class="bg-white font-sans text-gray-800">
  ...
  <section class="relative h-screen bg-cover bg-center text-white" style="background-image: url('https://i.ibb.co/mCGxpQtD/FB-IMG-17369745733970614.jpg');">
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
      ...
      <div class="flex gap-4">
        ...
        <a href="/leaderboard" class="border-2 border-white text-white px-6 py-3 rounded-lg text-lg hover:bg-white hover:text-goldenrod transition">
          Leaderboard
        </a>
      </div>
    </div>
  ...
  <div id="appModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-md w-full text-center slide-in">
      ...
      <a href="https://drive.google.com/file/d/1lbcZaGgXl731ZVauhx6uHPKtb3pngyQx/view?usp=drivesdk" class="bg-goldenrod text-white px-6 py-2 rounded-lg font-semibold hover:opacity-90 transition">Download App</a>
      <br/><br/>
